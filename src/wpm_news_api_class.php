  ...
  class Wpm_News_Api_Class {
    ...
    */
    public function wpm_action_links( $links ) {
      ...
      $links[] = '<a href="'. WPMNAPI_WPMAGIC_WEBSITE .'?mtm_campaign=plugins_list&mtm_source=wpmnews&mtm_medium=free" target="_blank">'.__( $this->wpmTexts['txt_11'], "wpm-news-api" ).'</a>';
      return $links;
    }
    ...
    */
    public function wpmnewsapi_help() {
      ...
      _e( '<h5><a href="'.WPMNAPI_DOCS.'" target="_blank" class="helpqmark">'.$this->wpmTexts['docs'].'</a></h5>', "wpm-news-api" );
