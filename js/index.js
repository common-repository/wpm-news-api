    ...
    $(function(){
        ...
        */
        ...
        $(".fetch").click(function(){ 
            ...
            alert('Great!\nWhen the news is fetched, new news channels will be available. Do not forget to pair them with categories in the "News to Post category Pairing" section before clicking on the "Publish all" button.');
