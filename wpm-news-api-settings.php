...
define( 'WPMNAPI_DOCS', 'https://www.wpmagic.cloud/docs/news-publisher-autopilot-plugin-docs/' );
...
$wpmTexts = array(
    "help_1"        => sprintf(  
                        ...
                        <div class='alert alert-info alert-dismissible fade show alerthelp1' role='alert'>
                            <details open>
                                ...
                                <p class='mt-3 ml-2'>" . 
                                    __( "The WPMagic Automated News plugin will run on its own after a quick setup.", "wpm-news-api" ) . "<br />" . 
                                    __( "Follow the instructions below to fill in the required data. After that, sit back and enjoy a fully automated news website.", "wpm-news-api" ) . 
                                "</p>
                                <p class='mt-3 ml-2'>" . 
                                    __( "First, add your API key from newsapi.org. Go ahead and hit the \"Fetch latest news\" button in order to fetch some news (see that it is working).", "wpm-news-api" ) . "<br />" . 
                                    __( "After that, configure the article source as a post category in two steps. In the 'Configure Article Source as Post Category' menu <ul style='font-size: 13px; padding-left: 20px;'><li>1) Choose the default \"News\" Category.</li><li>2) Select the categories in which to publish each news source (News to Post Category Pairing).</li></ul><p>New sources will be available periodically as they appear with the fetched news, so make sure you check the new news sources (News to Post category Pairing) periodically. Click on the \"Save changes\" button.", "wpm-news-api" ) . "<br />" . 
                                    __( "Press the \"Publish all\" button in order to publish the news. After that, the news will be published automatically when the <a href='https://www.google.com/search?q=WP-Cron+Scheduling' target='_blank'>WP-Cron</a> runs.", "wpm-news-api" ) . "<br />" . 
    ...
    "txt_10"        => sprintf( 
                            __( 'Click on the link above to get the latest news from the chosen API URL.', "wpm-news-api")
                        ),
    "txt_11"        => sprintf( 
                            __( 'More plugins from', "wpm-news-api") . ' WPMagic'
                        ),
    "txt_12"        => sprintf( 
    ...
    "txt_15"        => sprintf( 
                            ...
                            '<br />' . __( 'This will help organise the site. Each story from a particular source (ex. news.com.au) will be published in a specific category (ex. "News" or "Latest").', "wpm-news-api" ) .
                            '<br />' . __( 'You can see the source for each article below, in the list of fetched articles.', "wpm-news-api" )
                    ),
    "txt_16"        => sprintf( 
                            __( 'New * ', "wpm-news-api" )
                        ),
    ...
    "litevinfo"     => sprintf( 
                            __( '<section class="litevinfo">
                                    ...
                                    <p>Download the <a href="https://www.wpmagic.cloud/product/wpm-news-api-premium-wordpress-plugin/?mtm_campaign=configure_categories&mtm_source=wpmnews&mtm_medium=free" target="_blanck">WPM News API Plugin Premium</a> and unlock <i class="fa fa-unlock-alt" aria-hidden="true"></i> all News sources.</p>
                                </section>',
                                "wpm-news-api" )
                        ),
    "locksign"      => sprintf( 
